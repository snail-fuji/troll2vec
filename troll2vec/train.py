...
from troll2vec.utils import auc_roc
...
def save_parameters(vocabulary_inv, max_length):
    vocabulary = {value: key for key, value in vocabulary_inv.items()}
    json_dict = {
...
def load_data(data_source):
    ...
    if data_source == "keras_data_set":
        ...
        x, y, vocabulary, vocabulary_inv_list, max_length = data_helpers.load_data()
